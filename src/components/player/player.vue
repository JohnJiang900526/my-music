<template>
  <div class="player" v-show="playlist.length > 0">
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar ref="progressBar" :percent="percent" @percentChanging="onProgressBarChanging" @percentChange="onProgressBarChange"></progress-bar>
            </div>
    ...
    <audio ref="audio" @pause="paused" @ended="end" @timeupdate="updateTime" @playing="ready" @error="error" ></audio>
  </div>
</template>
